...
export var LevelSelect = function (props) {
    ...
    return (React.createElement(Root, null,
        React.createElement(List, { component: "nav", "aria-label": translate('ra.tiptap.select_level', {
            ...
            React.createElement(ListItem, { className: clsx((_a = {},
                    _a[classes.sizeSmall] = size === 'small',
                    _a[classes.sizeLarge] = size === 'large',
                    _a)) },
                React.createElement(ListItemButton, { "aria-haspopup": "true", "aria-controls": "level-menu", "aria-label": translate('ra.tiptap.current_level', {
                        _: 'Current level',
