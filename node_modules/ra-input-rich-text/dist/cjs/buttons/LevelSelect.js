...
var LevelSelect = function (props) {
    ...
    return (React.createElement(Root, null,
        React.createElement(material_1.List, { component: "nav", "aria-label": translate('ra.tiptap.select_level', {
            ...
            React.createElement(material_1.ListItem, { className: (0, clsx_1.default)((_a = {},
                    _a[classes.sizeSmall] = size === 'small',
                    _a[classes.sizeLarge] = size === 'large',
                    _a)) },
                React.createElement(material_1.ListItemButton, { "aria-haspopup": "true", "aria-controls": "level-menu", "aria-label": translate('ra.tiptap.current_level', {
                        _: 'Current level',
                    }), disabled: !(editor === null || editor === void 0 ? void 0 : editor.isEditable), onClick: handleClickListItem },
