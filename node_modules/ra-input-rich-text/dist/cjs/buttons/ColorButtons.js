...
var ColorButtons = function (props) {
    ...
    return (React.createElement(material_1.Box, { sx: { position: 'relative' } },
        React.createElement(OutsideListener, { onClick: function () { return setShowColorChoiceDialog(false); } },
            React.createElement(material_1.ToggleButtonGroup, null,
                React.createElement(material_1.ToggleButton, __assign({ "aria-label": colorLabel, title: colorLabel }, props, { disabled: !editor || !editor.isEditable, value: "color", onClick: function () { return displayColorChoiceDialog(ColorType.FONT); } }),
                    React.createElement(FormatColorText_1.default, { fontSize: "inherit" })),
                React.createElement(material_1.ToggleButton, __assign({ "aria-label": highlightLabel, title: highlightLabel }, props, { disabled: !editor || !editor.isEditable, value: "highlight", onClick: function () {
                        return displayColorChoiceDialog(ColorType.BACKGROUND);
                    } }),
                    React.createElement(FontDownload_1.default, { fontSize: "inherit" }))),
            showColorChoiceDialog && (React.createElement(ColorChoiceDialog, { editor: editor, close: function () { return setShowColorChoiceDialog(false); }, colorType: colorType })))));
};
