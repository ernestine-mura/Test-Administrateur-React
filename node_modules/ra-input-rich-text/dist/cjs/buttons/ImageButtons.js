...
var ImageButtons = function (props) {
    ...
    return (React.createElement(material_1.ToggleButton, __assign({ "aria-label": label, title: label }, props, { disabled: !editor || !editor.isEditable, value: "image", onClick: addImage }),
        React.createElement(Image_1.default, { fontSize: "inherit" })));
};
